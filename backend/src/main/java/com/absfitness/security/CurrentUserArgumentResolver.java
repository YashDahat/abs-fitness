package com.absfitness.security;
 ...
 * there is no extra query. Registered in {@link com.absfitness.config.WebConfig}. Domain
 ...
 * {@link com.absfitness.repository.UserRepository}, never stored as the domain reference.)
 */
@Component
