...
public class S3Config {
    ...
    public S3Client s3Client(
            ...
            @Value("${s3.path-style:true}") String pathStyleRaw) {

        // The value can be "true", "false", or a placeholder from the environment.
        // Default to true for any value that isn't explicitly "false".
        boolean pathStyle = !"false".equalsIgnoreCase(pathStyleRaw);
